...
class CreateCursorWith {
  ...
  #currentPoint: Meta['currentPoint'];
  #targetPoint: Meta['targetPoint'];
  #trackPoints: Meta['trackPoints'];
  #loopId: Meta['loopId'];
  #subLoopId: Meta['subLoopId'];
  #targetElement: Meta['targetElement'];
  #oldTargetElement: Meta['oldTargetElement'];
  #targetStyle: Meta['targetStyle'];
  #oldTargetStyle: Meta['oldTargetStyle'];
  #clickEffectTrigger: Meta['clickEffectTrigger'];
  #clickEffectRestore: Meta['clickEffectRestore'];
  #useFns: Meta['useFns'];
  #onMouseMoveFns: Meta['onMouseMoveFns'];
